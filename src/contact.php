            ...
            <div class="col-6 mx-auto">
                <form method="post" action="contact.php">
                    ...
                    <div class="form-group mt-4">
                        ...
                        <input class="form-control" value="<?php echo $username; ?>" type="username" id="username" name="username" placeholder="mr">
                    </div>
                    <div class="form-group mt-2">
                        <label for="email">Email:</label>
                        <input class="form-control" value="<?php echo $email; ?>" type="email" id="email" name="email" placeholder="example@example.com">
                    </div>
                    <div class="form-group mt-2">
                    ...
                    <div class="d-flex justify-content-center align-items-center my-4">
                        <button type="submit" name="contuct_user" class="btn btn-secondary">Send</button>
                    </div>
                </form>
            </div>
        </div>
